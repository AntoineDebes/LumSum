...
export class Blog1613240541273 implements MigrationInterface {
    name = 'Blog1613240541273'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `blogs` ADD `ownerId` varchar(36) NULL");

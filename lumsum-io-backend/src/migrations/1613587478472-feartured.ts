...
export class feartured1613587478472 implements MigrationInterface {
    name = 'feartured1613587478472'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `suppliers` ADD `featured` tinyint NOT NULL DEFAULT 0");
        await queryRunner.query("ALTER TABLE `blogs` DROP FOREIGN KEY `FK_998d6c1e3c685955774e5195f49`");
        await queryRunner.query("ALTER TABLE `blogs` CHANGE `ownerId` `ownerId` varchar(36) NULL");
        ...
        await queryRunner.query("ALTER TABLE `blogs` ADD CONSTRAINT `FK_998d6c1e3c685955774e5195f49` FOREIGN KEY (`ownerId`) REFERENCES `admins`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `blogs` CHANGE `ownerId` `ownerId` varchar(36) NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `blogs` ADD CONSTRAINT `FK_998d6c1e3c685955774e5195f49` FOREIGN KEY (`ownerId`) REFERENCES `admins`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `suppliers` DROP COLUMN `featured`");
    }

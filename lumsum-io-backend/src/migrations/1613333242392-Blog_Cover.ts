...
export class BlogCover1613333242392 implements MigrationInterface {
    name = 'BlogCover1613333242392'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `blogs` ADD `cover` text NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `blogs` ADD CONSTRAINT `FK_998d6c1e3c685955774e5195f49` FOREIGN KEY (`ownerId`) REFERENCES `admins`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `blogs` DROP COLUMN `cover`");
    }

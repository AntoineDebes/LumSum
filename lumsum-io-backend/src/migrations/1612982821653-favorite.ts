...
export class favorite1612982821653 implements MigrationInterface {
    name = 'favorite1612982821653'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `suppliers` ADD `customer_id` varchar(36) NULL");

...
import SUPPLIER from "../../../graphql/supplier.query";
import styles from "../../../styles/supplier-details.module.scss";
import SupplierImages from "src/components/SupplierImages";
...
export default function ProductDetails({ fullUrl }) {
    ...
    const { category, product, supplier } = router.query;
    ...
    const shareUrl = `https://www.lumsum.io/${category}/${product}/${supplier}`;
    ...
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href={`https://www.lumsum.io/${category}/${product}/${supplier}`} />
                <meta content={data.supplier.tradeName} name="title" />
                <meta content={data.supplier.tradeName} name="description" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={`https://www.lumsum.io/${category}/${product}/${supplier}`} />
                <meta property="og:title" content={data.supplier.tradeName} />
                <meta property="og:description" content={data.supplier.tradeName} />
                <meta property="og:image" content={`${process.env.UPLOAD_URL}${data?.supplier?.logo}`} />
                <meta property="twitter:type" content="website" />
                <meta property="twitter:url" content={`https://www.lumsum.io/${category}/${product}/${supplier}`} />
                <meta property="twitter:title" content={data.supplier.tradeName} />
                <meta property="twitter:description" content={data.supplier.tradeName} />
                <meta property="twitter:image" content={`${process.env.UPLOAD_URL}${data?.supplier?.logo}`} />
            </Head>

            <main>
                <BreadCrumb title="Supplier">
                    <BreadCrumb.ItemLink href="/">Home</BreadCrumb.ItemLink>
                    <BreadCrumb.ItemLink href={`/${category}`}>{data?.category?.name || ""}</BreadCrumb.ItemLink>
                    <BreadCrumb.ItemLink href={`/${category}/${product}`}>{data?.product?.name || ""}</BreadCrumb.ItemLink>
                </BreadCrumb>
